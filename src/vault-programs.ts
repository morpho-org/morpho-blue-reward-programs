...
export const vaultPrograms: VaultRewardProgramArgs[] = [
  ...
  // Re7 Universal USDC Vault - 6.53 uSOL 1/20-3/17 3pm GMT
  {
    start: 1737381600n,
    end: 1742220000n,
    fundsSender: "0x59e7682CcbdB40e4e8B73899a7CF3589026E783B",
    ...
    tokenAddress: "0x9B8Df6E244526ab5F6e6400d331DB28C8fdDdb55",
    vault: "0xB7890CEE6CF4792cdCC13489D36D9d42726ab863",
    amount: parseUnits("6.538208431641284", 18),
    chainId: ChainId.BASE,
  },
  // Re7 Universal USDC Vault - 238.03 uSUI 1/20-3/17 3pm GMT
  {
    ...
    tokenAddress: "0xb0505e5a99abd03d94a1169e638B78EDfEd26ea4",
    vault: "0xB7890CEE6CF4792cdCC13489D36D9d42726ab863",
    amount: parseUnits("238.0334153893274", 18),
    chainId: ChainId.BASE,
  },
  // Re7 Universal USDC Vault - 136.25 uAPT 1/20-3/17 3pm GMT
  {
    start: 1737381600n,
    end: 1742220000n,
    fundsSender: "0x59e7682CcbdB40e4e8B73899a7CF3589026E783B",
    ...
    vault: "0xB7890CEE6CF4792cdCC13489D36D9d42726ab863",
    amount: parseUnits("136.24977817197893", 18),
    chainId: ChainId.BASE,
  },
];
